...
export function Hero() {
    return (
        <section className="relative isolate bg-peach-gradient bg-[var(--beige)]/30 mt-20">
            ...
            <div className="grid grid-cols-2 items-center gap-16 mt-6">
                ...
                <div className="">
                    ...
                    <h1 className="mt-5 font-display text-4xl font-medium font-serif text-[var(--greenShade)] leading-tight">
