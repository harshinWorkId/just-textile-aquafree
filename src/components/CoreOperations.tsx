...
const CoreOperations: React.FC = () => {
    ...
    return (
        ...
        <section ref={sectionRef} className="py-20 overflow-x-hidden bg-[var(--grayish)]/30" >
            <div className="mx-auto max-w-7xl px-6 lg:px-8 relative py-0 max-md:py-0 max-xl:py-0 rounded-2xl">
                <div className="mx-auto max-w-2xl text-center mb-16">
