  ...
  return (
    ...
    <section className="py-12 md:py-20 font-sans text-gray-800 relative" >
      <div className="max-w-7xl bg-white/80  mx-auto px-4 sm:px-6 lg:p-12 relative rounded-2xl">
        ...
        <p className="text-[22px] leading-relaxed mb-12 md:mb-16">
        ...
        <div className="relative flex flex-col items-center mb-16 md:mb-0">
          ...
          <div className="hidden md:block absolute top-[130px] left-0 right-0 h-px bg-gray-700 mx-auto w-11/12 xl:w-full"></div>
        ...
        <p className="text-[22px] leading-relaxed mx-auto md:mx-0 text-[var(--bodyContent)]">
